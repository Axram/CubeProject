...
// alex
//double RAD_TO_DEG = 57296/1000;
double accX = AN[3], accY = AN[4], accZ = AN[5];
double gyroX = AN[0], gyroY = AN[1], gyroZ = AN[2];
...
void loop() //Main Loop
{
  if((millis()-timer)>=20)  // Main loop runs at 50Hz
  {
    ...
    {
      //Serial.println("HEEEEEEEEEEEEEEEEEEEERE");
      kalmanX.setAngle(ToDeg(roll));
      kalAngleX = ToDeg(roll);
    } 
    else
    {
