...
\textbf{Symbols} 	& \textbf{Description} \vspace{.5em} \\
...
\end{align}
%\end{equation}
Whereas $\theta$ represents the angle of the cube and $\phi$ is the position of the flywheel.  MER KOMMER MEN NU TAR JAG FREDAG, ITS FRIDAY
\section{Software}
