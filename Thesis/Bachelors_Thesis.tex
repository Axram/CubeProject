...
The discrete Kalman filter which is applied to the problem at hand is a state based estimator. By using the measurements from both the accelerometer and the gyro from the past, present (future??) it can derive a good estimate of the state of the  cube's position.
