...
We would like to thank Daniel Frede, our supervisor, always ready with his well filled beer glass, for his continuous support and German \textit{precision}. Staffan Qvarnström and Tomas Östberg for their mechanical and practical expertise. As well all the student assistants that have helped us throughout the course.
...
\chapter{Design and what}

\textsc{Kapitelintro?}
This chapter covers the designing of the demonstrator and implementation of software and electronics in the cube.
...
Figure \ref{Fig: Pz & RootLocus} shows the Pole-Zero map and Root locus of the system indicating that the system is unstable in the open loop system. \cite{regler} To evaluate if the closed loop system is stable with a scalar gain $K$, Root Locus in Figure \ref{Fig: Root Locus} is used which indicates that the system is unstable with a loop gain $K$.
