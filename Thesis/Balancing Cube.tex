...
The problem with an IMU is that that the signal contains a lot of noise. The accelerometer can be accounted for measurements over a longer period but not short term. The gyroscope on the other hand, drifts over time and is only reliable during short accelerations. 
